...
Page({
  ...
  saveClick: function () {
    ...
    // 登录服务器接口 
    wx.request({
      url: 'http://qingchun.hongquelin.com/zhinenghuajiang/api.php?act=seek_phone&app=10000&newphone=' + this.data.tel + '&crc=' + this.data.code + '&token=adcf619f199ff6a9e2e7ba8209644101',//调用全局登录获取到的token这里只是测试的
      data: {
      },
      method: "POST",
      header: {
