...
Page({
  ...
  onChange: tool.debounce(function (e) {
    ...
    wx.request({
      url: `http://qingchun.hongquelin.com/zhinenghuajiang/api.php?act=huacao&app=10000&name=%${this.data.value}%`,
      data: {},
  ...
  onLoad: function (options) {
    var that = this
    wx.request({
      url: `http://qingchun.hongquelin.com/zhinenghuajiang/api.php?act=renqi&app=10000`,
      data: {},
      header: { 'content-type': 'application/json' },
      method: 'GET',
      dataType: 'json',
